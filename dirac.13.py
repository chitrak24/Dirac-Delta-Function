...
#Representation using Airy Function
#\epsilon ---> 0
#func = airy(x/\epsilon)/\epsilon
...
def ddf(x,eps):
    ai, aip, bi, bip = airy(x/eps)
    return ai/eps
print("Representation of Dirac Delta function using Airy Function")
...
#evaluating intrgral
xp = np.linspace(a-5.1*eps,a+5.1*eps,10)
